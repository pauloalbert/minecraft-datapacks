...
execute as @e[type=minecraft:wandering_trader,tag=!has_new_trim_trades] at @s run scoreboard players set @s math_input1 -2
execute as @e[type=minecraft:wandering_trader,tag=!has_new_trim_trades] at @s run scoreboard players set @s math_input2 1
execute as @e[type=minecraft:wandering_trader,tag=!has_new_trim_trades] at @s run function wandering_trades:math/random
execute as @e[type=minecraft:wandering_trader,tag=!has_new_trim_trades] at @s run function wandering_trades:provide_trim_trades
